  ...
  const education = [
    {
      ...
      school: "Swarnandhra College of Engineering & Technology (JNTU Kakinada)",
      year: "2023 – 2027",
      badge: "CGPA: 7.31",
      badgeIcon: Award,
    ...
    },
    {
      ...
      school: "Vidya Vikas Junior College, Sangareddygudem",
      year: "2021 – 2023",
      badge: "855/1000 (Grade A)",
      badgeIcon: Sparkles,
      badgeColor: "text-primary bg-primary/10 border-primary/30",
      icon: BookOpen,
      details: [
        "Board of Intermediate Education, Andhra Pradesh",
        "Rigorous quantitative foundation in differential calculus, linear algebra, and physics",
        "Graduated with Grade A distinction (85.5% aggregate)"
      ]
    },
    {
      degree: "Secondary School Certificate (SSC)",
      school: "St. Joseph's EM High School, Vellachinthalagudem",
      year: "2020 – 2021",
      badge: "80.83% First Division",
      badgeIcon: Sparkles,
      badgeColor: "text-cyan-400 bg-cyan-500/10 border-cyan-500/30",
      icon: BookOpen,
      details: [
        "State Board of Secondary Education",
        "Secured 485/600 (80.83%) with First Division distinction in sciences and mathematics"
      ]
    }
  ];
