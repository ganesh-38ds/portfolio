        ...
        <div className="relative z-10 flex flex-col md:flex-row gap-12 md:gap-24">
          ...
          <div className="flex-1 space-y-8">
            ...
            <div className="space-y-6">
              <a href="mailto:ganeshgudla944@gmail.com" className="flex items-center gap-4 text-muted-foreground hover:text-primary transition-colors cursor-pointer group">
                ...
                <span className="font-medium">ganeshgudla944@gmail.com</span>
              </a>
              <a href="tel:+919347275583" className="flex items-center gap-4 text-muted-foreground hover:text-primary transition-colors cursor-pointer group">
                <div className="w-12 h-12 rounded-full glass-panel flex items-center justify-center group-hover:scale-110 transition-transform">
                  <Phone className="w-5 h-5" />
                </div>
                <span className="font-medium">+91 93472 75583</span>
              </a>
