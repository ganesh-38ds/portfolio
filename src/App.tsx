...
import { Home, User, GraduationCap, Award, Briefcase, FolderKanban, Send, Code2 } from "lucide-react";
...
function App() {
  ...
  const dockItems = [
    ...
    { icon: <Code2 size={20} />, label: "Skills", onClick: () => scrollToSection("skills") },
    { icon: <Award size={20} />, label: "Certifications", onClick: () => scrollToSection("certifications") },
